 ...
 */
public class SuccessfulFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button backHome = view.findViewById(R.id.btnTakeMeHome);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.btnTakeMeHome){
            Navigation.findNavController(v).navigate(R.id.success_to_home);
        }
    }
}